...
function main {
    ...
    echo "#!/bin/bash" > /home/$username/scripts/performance-mode.sh
    echo "cat /sys/devices/system/cpu/cpu*/cpufreq/scaling_governor" >> /home/$username/scripts/performance-mode.sh
    echo 'for file in /sys/devices/system/cpu/cpu*/cpufreq/scaling_governor; do echo "performance" > $file; \e[1;32m[DONE]\e[1;0m' >> /home/$username/scripts/performance-mode.sh
    echo "cat /sys/devices/system/cpu/cpu*/cpufreq/scaling_governor" >> /home/$username/scripts/performance-mode.sh

    echo "#!/bin/bash" > /home/$username/scripts/execute-performance-mode-sh-as-root.sh
    echo 'pass="test"' >> /home/$username/scripts/execute-performance-mode-sh-as-root.sh
    echo 'sleep 3' >> /home/$username/scripts/execute-performance-mode-sh-as-root.sh
    echo 'chmod +x performance-mode.sh' >> /home/$username/scripts/execute-performance-mode-sh-as-root.sh
    echo 'echo $pass | sudo -S bash performance-mode.sh' >> /home/$username/scripts/execute-performance-mode-sh-as-root.sh
